    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="col-sm-3 d-flex justify-content-center align-items-center ">
                <a href="?weekDate=<?= $previousWeekDate ?>" class="btn CoralButton">Previous Week</a>
            </div>
                <div class="col-sm-6 d-flex justify-content-center align-items-center" >
                <h2 class="d-flex">Weekly Schedule (<?= htmlspecialchars($startOfWeek) ?> to <?= htmlspecialchars($endOfWeek) ?>)</h2>
                </div>
                <div class="col-sm-3 d-flex justify-content-center align-items-center" >
                <a href="?weekDate=<?= $nextWeekDate ?>" class="btn CoralButton">Next Week</a>
                </div>
            </div>
            <table>
                <thead>
